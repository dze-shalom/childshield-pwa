...
export const translations = {
  ...
  alert: {
    ...
    photoCopied:  { en: 'Photo copied! In WhatsApp, tap the 📎 attachment button to add it before sending.', fr: 'Photo copiée! Dans WhatsApp, appuyez sur 📎 pour l\'ajouter avant d\'envoyer.', pe: 'Photo don copy! For WhatsApp, tap 📎 to attach am before you send.' },
  ...
  // ── WhatsApp share message labels ────────────────────────────────────────
  share: {
    missingTitle:  { en: 'MISSING CHILD ALERT',            fr: 'ALERTE ENFANT DISPARU',                  pe: 'PIKIN DON LOST ALERT' },
    platform:      { en: 'ChildShield Cameroon',            fr: 'ChildShield Cameroun',                   pe: 'ChildShield Cameroon' },
    name:          { en: 'Name',                            fr: 'Nom',                                    pe: 'Name' },
    age:           { en: 'Age',                             fr: 'Âge',                                    pe: 'Age' },
    yearsOld:      { en: 'years old',                       fr: 'ans',                                    pe: 'years' },
    lastSeen:      { en: 'Last seen',                       fr: 'Vu en dernier',                          pe: 'Last see am' },
    time:          { en: 'Time',                            fr: 'Heure',                                  pe: 'Time' },
    description:   { en: 'Description',                     fr: 'Description',                            pe: 'How e look' },
    contact:       { en: 'Contact',                         fr: 'Contact',                                pe: 'Contact' },
    reportLink:    { en: 'Report sightings',                fr: 'Signaler des observations',              pe: 'Report if you see am' },
    appeal:        { en: 'Please share widely. Every second counts.', fr: 'Partagez largement. Chaque seconde compte.', pe: 'Please share am. Every second matter.' },
    footer:        { en: 'ChildShield — Community Child Safety', fr: 'ChildShield — Sécurité Communautaire', pe: 'ChildShield — Community Child Safety' },
    foundTitle:    { en: 'CHILD FOUND — Thank You!',        fr: 'ENFANT RETROUVÉ — Merci!',               pe: 'DEM FIND PIKIN — Thank You!' },
    foundNews:     { en: 'Great news!',                     fr: 'Bonne nouvelle!',                        pe: 'Good news!' },
    foundSafe:     { en: 'has been found safe!',            fr: 'a été retrouvé(e) sain(e) et sauf(ve)!', pe: 'don reach house safe!' },
    foundThanks:   { en: 'Thank you to every member of the ChildShield community who shared this alert. Your help made a real difference.', fr: 'Merci à chaque membre de la communauté ChildShield qui a partagé cette alerte. Votre aide a fait une vraie différence.', pe: 'Thank una wey share dis alert. Your help don help plenty.' },
  },

  // ── Abuse Report ─────────────────────────────────────────────────────────
  abuse: {
    title:        { en: 'Safe Reporting',                   fr: 'Signalement Sûr',                        pe: 'Report Safe' },
    subtitle:     { en: 'Sexual Harassment & Abuse',        fr: 'Harcèlement Sexuel & Abus',              pe: 'Bad Touch & Abuse' },
    quickExit:    { en: 'Quick Exit',                       fr: 'Sortie Rapide',                          pe: 'Exit Quick' },
    privacy:      { en: 'Your privacy is completely protected', fr: 'Votre confidentialité est totalement protégée', pe: 'Your privacy dey protected' },
    privacySub:   { en: 'No name, no phone number, no identity stored. Reports go only to trained child protection specialists.', fr: 'Aucun nom, aucun numéro, aucune identité stockée. Les rapports vont uniquement aux spécialistes formés.', pe: 'No name, no number, no identity stored. Report go only to trained people.' },
    howHelp:      { en: 'How can we help you?',             fr: 'Comment pouvons-nous vous aider?',        pe: 'How we fit help you?' },
    safeSpace:    { en: 'This is a safe, private space. What happened to you or a child you know is not your fault.', fr: 'C\'est un espace sûr et privé. Ce qui vous est arrivé n\'est pas de votre faute.', pe: 'Dis na safe place. Wetin happen to you no be your fault.' },
    danger:       { en: 'If you are in immediate danger',  fr: 'Si vous êtes en danger immédiat',         pe: 'If you dey danger now' },
    callPolice:   { en: 'Call Police — 17',                 fr: 'Appelez la Police — 17',                  pe: 'Call Police — 17' },
    reportAbuse:  { en: 'Report sexual abuse or harassment', fr: 'Signaler abus ou harcèlement sexuel',   pe: 'Report bad touch or harassment' },
    reportSub:    { en: 'Confidential report — takes 3 minutes', fr: 'Rapport confidentiel — 3 minutes', pe: 'Confidential report — 3 minutes' },
    findSupport:  { en: 'Find support and resources',       fr: 'Trouver soutien et ressources',          pe: 'Find help and resources' },
    findSupportSub:{ en: 'Hospitals, NGOs, legal help near me', fr: 'Hôpitaux, ONG, aide juridique',     pe: 'Hospital, NGO, legal help near you' },
    understand:   { en: 'Understand what happened',         fr: 'Comprendre ce qui s\'est passé',         pe: 'Understand wetin happen' },
    understandSub:{ en: 'What counts as abuse? What are my rights?', fr: 'Qu\'est-ce que l\'abus? Quels sont mes droits?', pe: 'Wetin be abuse? Wetin be my rights?' },
    whoReport:    { en: 'Who is making this report?',       fr: 'Qui fait ce signalement?',               pe: 'Who dey make dis report?' },
    whoSub:       { en: 'Your answer helps us guide you to the right support. You remain completely anonymous.', fr: 'Votre réponse nous aide à vous orienter. Vous restez complètement anonyme.', pe: 'Your answer go help us guide you. You go remain anonymous.' },
    whoChild:     { en: 'I am a child and this happened to me', fr: 'Je suis un enfant et c\'est arrivé', pe: 'Na me be di pikin and e happen to me' },
    whoParent:    { en: 'My child told me something happened', fr: 'Mon enfant m\'a dit quelque chose',  pe: 'My pikin tell me say something happen' },
    whoWitness:   { en: 'I witnessed or suspect abuse of a child', fr: 'J\'ai été témoin ou je suspecte', pe: 'I see or I suspect abuse of pikin' },
    whoTeacher:   { en: 'I am a teacher or school staff',  fr: 'Je suis enseignant ou personnel scolaire', pe: 'Na me be teacher or school staff' },
    continue:     { en: 'Continue',                         fr: 'Continuer',                              pe: 'Continue' },
    back:         { en: 'Back',                             fr: 'Retour',                                 pe: 'Go Back' },
    whatHappen:   { en: 'What happened?',                   fr: 'Que s\'est-il passé?',                   pe: 'Wetin Happen?' },
    ownWords:     { en: 'In your own words (optional)',     fr: 'En vos propres mots (optionnel)',        pe: 'Talk am your own way (optional)' },
    whoDid:       { en: 'Who did this? (optional)',         fr: 'Qui a fait ça? (optionnel)',             pe: 'Who do am? (optional)' },
    whereHappen:  { en: 'Where did this happen?',          fr: 'Où cela s\'est-il passé?',               pe: 'Where e happen?' },
    submit:       { en: 'Submit Confidential Report',       fr: 'Soumettre le Rapport Confidentiel',      pe: 'Send Confidential Report' },
    received:     { en: 'Report Received',                  fr: 'Rapport Reçu',                          pe: 'Dem Don Receive Your Report' },
    receivedSub:  { en: 'You did the right thing. A trained child protection specialist will review this within 2 hours.', fr: 'Vous avez fait ce qu\'il fallait. Un spécialiste examinera ceci dans 2 heures.', pe: 'You do di right thing. Trained specialist go check am within 2 hours.' },
    backHome:     { en: 'Back to Home',                     fr: 'Retour à l\'Accueil',                   pe: 'Go Back Home' },
    close:        { en: 'Close this page immediately',      fr: 'Fermer cette page immédiatement',        pe: 'Close dis page now' },
    confirm:      { en: 'Confirm Child Found',              fr: 'Confirmer Enfant Retrouvé',              pe: 'Confirm Say Dem Find Pikin' },
  },

  // ── Dashboard ─────────────────────────────────────────────────────────────
  dash: {
    title:        { en: 'Dashboard',                        fr: 'Tableau de Bord',                        pe: 'Dashboard' },
    overview:     { en: 'Overview',                         fr: 'Aperçu',                                 pe: 'Overview' },
    incidents:    { en: 'Incidents',                        fr: 'Incidents',                              pe: 'Incidents' },
    resolutions:  { en: 'Resolutions',                      fr: 'Résolutions',                            pe: 'Resolutions' },
    activeAlerts: { en: 'Active Alerts',                    fr: 'Alertes Actives',                        pe: 'Active Alert Dem' },
    needsAtt:     { en: 'Needs attention',                  fr: 'Nécessite attention',                    pe: 'Need attention' },
    resolvedMonth:{ en: 'Resolved (May)',                   fr: 'Résolus (Mai)',                          pe: 'Done (May)' },
    thisMonth:    { en: 'This month',                       fr: 'Ce mois',                                pe: 'Dis month' },
    verifiedUsers:{ en: 'Verified Users',                   fr: 'Utilisateurs Vérifiés',                  pe: 'Verified Community' },
    guardians:    { en: 'Community guardians',              fr: 'Gardiens communautaires',                pe: 'Community guardians' },
    avgResponse:  { en: 'Avg Response',                     fr: 'Réponse Moy.',                           pe: 'Avg Response' },
    communityResp:{ en: 'Community response',               fr: 'Réponse communautaire',                  pe: 'Community response' },
    monthlyAlerts:{ en: 'Monthly Alerts',                   fr: 'Alertes Mensuelles',                    pe: 'Monthly Alert Dem' },
    alertVolume:  { en: 'Alert volume trend — 2026',        fr: 'Tendance des alertes — 2026',            pe: 'Alert trend — 2026' },
    byType:       { en: 'Incidents by Type',                fr: 'Incidents par Type',                     pe: 'Incident Type' },
    riskZones:    { en: 'AI Risk Heatmap — Top Zones',      fr: 'Carte des Risques — Zones Principales',  pe: 'AI Risk Map — Top Area' },
    totalReports: { en: 'community reports',                fr: 'rapports communautaires',                pe: 'community reports' },
    updated:      { en: 'Updated hourly',                   fr: 'Mis à jour chaque heure',               pe: 'Updated every hour' },
    foundSafely:  { en: 'children found safely this month', fr: 'enfants retrouvés sains ce mois',       pe: 'pikin dem wey dem find safe dis month' },
    communityCoord:{ en: 'Through community coordination', fr: 'Par coordination communautaire',          pe: 'Through community work' },
    totalReports2:{ en: 'total reports',                    fr: 'rapports totaux',                        pe: 'total reports' },
  },

  // ── Found Child ───────────────────────────────────────────────────────────
  found: {
    title:        { en: 'I Found a Child',                  fr: 'J\'ai Trouvé un Enfant',                 pe: 'I Find Pikin' },
    foundSomeone: { en: 'Found someone?',                   fr: 'Trouvé quelqu\'un?',                     pe: 'You find somebody?' },
    cardSub:      { en: 'AI instantly matches & contacts families', fr: 'L\'IA trouve et contacte les familles', pe: 'AI go find and contact family fast' },
    step1hint:    { en: 'Describe the child as accurately as possible. Once you submit, our system will automatically search and contact families.', fr: 'Décrivez l\'enfant aussi précisément que possible. Après soumission, notre système cherchera automatiquement.', pe: 'Describe di pikin well well. After you submit, system go search and contact family.' },
    descLabel:    { en: 'Describe the child *',             fr: 'Décrivez l\'enfant *',                   pe: 'Describe di pikin *' },
    descPH:       { en: 'What are they wearing? Age, hair, any marks, school uniform, bag...', fr: 'Que portent-ils? Âge, cheveux, marques, uniforme...', pe: 'Wetin e wear? Age, hair, any mark, school uniform, bag...' },
    approxAge:    { en: 'Approx. Age',                      fr: 'Âge Approximatif',                      pe: 'Approx Age' },
    unknown:      { en: 'Unknown',                          fr: 'Inconnu',                                pe: 'I no know' },
    gender:       { en: 'Gender',                           fr: 'Sexe',                                   pe: 'Boy or Girl' },
    girl:         { en: 'Girl',                             fr: 'Fille',                                  pe: 'Girl' },
    boy:          { en: 'Boy',                              fr: 'Garçon',                                 pe: 'Boy' },
    nextStep:     { en: 'Next: Where & How to Reach You →', fr: 'Suivant: Où & Comment vous Joindre →',  pe: 'Continue: Where & How to Reach You →' },
    whereFound:   { en: 'Where did you find the child? *',  fr: 'Où avez-vous trouvé l\'enfant? *',      pe: 'Where you find di pikin? *' },
    whereNow:     { en: 'Where is the child right now?',    fr: 'Où est l\'enfant maintenant?',           pe: 'Where di pikin dey now?' },
    whereNowPH:   { en: 'e.g. With me at Molyko / At Buea Police Station / At the hospital...', fr: 'ex. Avec moi à Molyko / Au commissariat / À l\'hôpital...', pe: 'e.g. E dey with me for Molyko / For Police Station / For hospital...' },
    yourContact:  { en: 'Your Contact Number *',            fr: 'Votre Numéro de Contact *',             pe: 'Your Phone Number *' },
    contactNote:  { en: 'If we find a match, the child\'s family will receive a WhatsApp with your number.', fr: 'Si nous trouvons une correspondance, la famille recevra un WhatsApp avec votre numéro.', pe: 'If we find match, family go receive WhatsApp with your number.' },
    submitBtn:    { en: 'Submit Report',                    fr: 'Soumettre le Rapport',                   pe: 'Send Report' },
    searching:    { en: 'Searching active alerts...',       fr: 'Recherche des alertes actives...',       pe: 'E dey search active alert dem...' },
    searchSub:    { en: 'Our AI is comparing your description against every active missing child alert. Families will be notified automatically if we find a match.', fr: 'Notre IA compare votre description à toutes les alertes actives. Les familles seront notifiées automatiquement.', pe: 'Our AI dey compare your description with all active missing child alert. Family go receive notification if we find match.' },
    submitted:    { en: 'Report submitted',                 fr: 'Rapport soumis',                        pe: 'Report Don Submit' },
    notified:     { en: 'We sent a WhatsApp alert to the family of',  fr: 'Nous avons envoyé un WhatsApp à la famille de', pe: 'We don send WhatsApp alert to family of' },
    noMatch:      { en: 'No active alerts match right now', fr: 'Aucune alerte active ne correspond',     pe: 'No active alert match now' },
    noMatchSub:   { en: 'Your report is saved. If a parent posts a matching alert later, they will be notified of your report.', fr: 'Votre rapport est enregistré. Si un parent publie une alerte correspondante, il sera notifié.', pe: 'Your report don save. If parent post matching alert later, dem go know about your report.' },
    callPolice:   { en: 'Call Police — 17',                 fr: 'Appeler la Police — 17',                pe: 'Call Police — 17' },
    matchFound:   { en: 'possible match found',             fr: 'correspondance possible trouvée',        pe: 'possible match dem find' },
    aiReason:     { en: 'AI:',                              fr: 'IA:',                                    pe: 'AI:' },
    reportedBy:   { en: 'Reported by:',                     fr: 'Signalé par:',                           pe: 'Reported by:' },
    whatsappFam:  { en: 'WhatsApp the family',              fr: 'WhatsApp à la famille',                  pe: 'WhatsApp di family' },
    aiNote:       { en: 'AI suggestions only — always confirm visually. Call 17 if urgent.', fr: 'Suggestions IA uniquement — confirmez toujours visuellement. Appelez le 17 si urgent.', pe: 'Na AI suggestion — always confirm am. Call 17 if e dey urgent.' },
    backHome:     { en: 'Back to Home',                     fr: 'Retour à l\'Accueil',                   pe: 'Go Back Home' },
    familyNotified:{ en: 'Family notified',                 fr: 'Famille notifiée',                      pe: 'Family don know' },
  },
}
